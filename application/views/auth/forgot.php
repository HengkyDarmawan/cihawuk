...
<section class="auth-shell">
	<div class="card-soft auth-card">
		...
		<h1>Lupa password</h1>
		<?php if ( ! empty($sent)): ?>
			<div class="alert alert-success d-flex gap-2" role="status"><?= icon('check-circle') ?><div>Jika email tersebut terdaftar dan sudah terverifikasi, tautan reset telah dikirim. Tautan berlaku 30 menit.</div></div>
		<?php endif; ?>
		<?php if ($mail_enabled): ?>
