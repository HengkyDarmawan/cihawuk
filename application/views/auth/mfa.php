		...
		<div class="card-soft auth-card">
			<div class="auth-form-inner">
				...
				<?php if ( ! empty($mfa_error)): ?>
					<div class="alert alert-danger d-flex gap-2 auth-inline-error" role="alert" data-swal-alert="error"><?= icon('alert-circle') ?><div><?= e($mfa_error) ?></div></div>
				<?php endif; ?>
				<form method="post" action="<?= site_url('mfa') ?>" data-once>
					...
					<button class="btn btn-primary btn-lg w-100" type="submit"><?= icon('shield') ?> Verifikasi</button>
				</form>
