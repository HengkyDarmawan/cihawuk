...
class DemoSeeder extends Seeder {
	...
	protected function accounts()
	{
		$definitions = array(
			...
			array('pelayanan.demo', 'Petugas Pelayanan (Demo)', array('service_admin')),
			array('koordinator.demo', 'Koordinator Pelayanan (Demo)', array('service_coordinator'), 'all'),
			array('petugas.demo', 'Petugas Lapangan (Demo)', array('officer'), 'PEMBANGUNAN'),
			array('petugas2.demo', 'Petugas Pelayanan Umum (Demo)', array('officer'), 'PELAYANAN'),
			array('loket.demo', 'Petugas Loket (Demo)', array('front_desk')),
			array('kades.demo', 'Kepala Desa (Demo)', array('village_head'), 'all'),
			array('webadmin.demo', 'Admin Website (Demo)', array('website_admin')),
			array('editor.demo', 'Editor Konten (Demo)', array('content_editor')),
			array('penerbit.demo', 'Penerbit Konten (Demo)', array('content_publisher')),
			array('verifikator.demo', 'Verifikator Data (Demo)', array('data_verifier')),
			array('keuangan.demo', 'Pengelola Keuangan (Demo)', array('finance_manager')),
			array('auditkeuangan.demo', 'Verifikator Keuangan (Demo)', array('finance_verifier')),
			array('aset.demo', 'Pengurus Aset (Demo)', array('asset_manager')),
			array('gudang.demo', 'Petugas Gudang (Demo)', array('warehouse_officer')),
			array('rahasia.demo', 'Penangan Laporan Rahasia (Demo)', array('officer', 'confidential_handler'), 'KESRA'),
